...
<template>
    <div class="create-order">
      ...
      <div class="good">
        <div class="good-item">
          <div class="good-img"><img :src="$filters.prefix(state.sckillItem.goodsCoverImg)" alt=""></div>
          <div class="good-desc">
            <div class="good-title">
              <span>{{ state.sckillItem.goodsName }}</span>
              <span>x{{ state.sckillItem.goodsCount }}</span>
            </div>
            <div class="good-btn">
              <div class="price">¥{{ state.sckillItem.seckillPrice }}</div>
            </div>
          </div>
        </div>
      </div>
...
import { getSecKillDetail } from '../service/secKill'
  ...
  const goTo = () => {
    router.push({ path: '/seckill-address', query: { seckillId: state.seckillId, from: 'create-seckill-order' }})
  }
